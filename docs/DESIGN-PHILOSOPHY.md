...
- Camera-wall tiles can use the app's softer `rounded-lg` radius, with matching rounded overlay chips/buttons, so preview cards feel less sharp without becoming decorative.
