...
- [Views](#views) — Bridge, People, Briefing, Library, Docs, and System
...
![Library feed](docs/screenshots/library-feed.png)
...
Top-level navigation is intentionally small: Bridge, People, Briefing, Library, Docs, and System. URLs are routeable (`/bridge`, `/people`, `/briefings`, `/library`, `/docs/...`, `/system/...`) so views can be bookmarked or opened by agents. The macOS app supports back/forward navigation and can be controlled from scripts through the local navigation endpoint.
...
>
> ```bash
> HILT_WORKING_FOLDER=./docs/demo BRIDGE_VAULT_PATH=./docs/demo npm run dev:all
> ```
>
> The demo includes briefings, tasks, projects, people, meetings, saved references, Library candidates, and source configs. It is the same content family used for the screenshots above.
...
graph TD
    subgraph Client["Browser / Electron"]
        App["Next.js React App<br/>Bridge · People · Briefing · Library · Docs · System"]
    end
