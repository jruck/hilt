...
Or try the included demo content first — set `HILT_WORKING_FOLDER=./demo` to see sample briefings, tasks, projects, and thoughts (the same content shown in the screenshots above).
