...
export function buildCandidateMarkdown(processed: ProcessedArtifact): string {
  ...
  const frontmatter: Record<string, unknown> = {
    ...
    embedded_video_page_url: typeof processed.raw.metadata.embedded_video_page_url === "string" ? processed.raw.metadata.embedded_video_page_url : undefined,
    embedded_video_provider: typeof processed.raw.metadata.embedded_video_provider === "string" ? processed.raw.metadata.embedded_video_provider : undefined,
    embedded_video_source: typeof processed.raw.metadata.embedded_video_source === "string" ? processed.raw.metadata.embedded_video_source : undefined,
    embedded_video_title: typeof processed.raw.metadata.embedded_video_title === "string" ? processed.raw.metadata.embedded_video_title : undefined,
    embedded_video_required: processed.raw.metadata.embedded_video_required === true ? true : undefined,
    embedded_video_transcript_status: typeof processed.raw.metadata.embedded_video_transcript_status === "string" ? processed.raw.metadata.embedded_video_transcript_status : undefined,
    embedded_video_transcript_method: typeof processed.raw.metadata.embedded_video_transcript_method === "string" ? processed.raw.metadata.embedded_video_transcript_method : undefined,
