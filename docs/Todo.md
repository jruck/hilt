...
- [ ] planning status, useful for literal claude planning and also when you're not sure you're ready to build yet. optional step, likely aligns with need to do a worktree.
- [ ] when hovering over the top-right card icons, the text underneath should dim a bit so you can make out the icons. make it a gradient effect that starts at the top of the card and fades back in completely below where the icons stop.
...
- [ ] Push notifications — Browser/OS notifications for background tasks
