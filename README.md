...
- [Views](#views) — Briefing, Bridge, People, Library, Docs, and System
...
Top-level navigation is intentionally small: Briefing, Bridge, People, Library, Docs, and System. URLs are routeable (`/briefings`, `/bridge`, `/people`, `/library`, `/docs/...`, `/system/...`) so views can be bookmarked or opened by agents. Hilt still opens Bridge by default until Briefing is strong enough to be the landing surface. The macOS app supports back/forward navigation and can be controlled from scripts through the local navigation endpoint.
