...
export const PIPELINE_VERSION = "v2.6";
 ...
 * same reweave contract use Claude's native structured output, v2.5 adds a gated embedded-video
 * transcript capture path, and v2.6 makes the card description strictly source-centric. None changes
 * the published digest voice, so older items are not
 ...
 */
export const CURRENT_PIPELINE_VERSIONS: ReadonlySet<string> = new Set([PIPELINE_VERSION, "v2.5", "v2.4", "v2.3", "v2.2", "v2.1", "v2"]);
